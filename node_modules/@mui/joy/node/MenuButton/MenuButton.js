...
var _useMenuButton = _interopRequireDefault(require("@mui/base/useMenuButton"));
...
const useUtilityClasses = ownerState => {
  ...
  return (0, _composeClasses.default)(slots, _menuButtonClasses.getMenuButtonUtilityClass, {});
};
const MenuButtonRoot = (0, _styles.styled)('button', {
  name: 'JoyMenuButton',
  slot: 'Root',
  overridesResolver: (props, styles) => styles.root
})(_Button.getButtonStyles);
exports.MenuButtonRoot = MenuButtonRoot;
