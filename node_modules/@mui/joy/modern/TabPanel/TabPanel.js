...
const _excluded = ["children", "value", "component", "color", "variant", "size", "slots", "slotProps"];
...
}, theme.typography[`body-${ownerState.size}`], theme.variants[ownerState.variant]?.[ownerState.color]));
/**
 *
 * Demos:
 *
