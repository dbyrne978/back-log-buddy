...
const CardRoot = styled('div', {
  ...
  }, theme.typography[`body-${ownerState.size}`], theme.variants[ownerState.variant]?.[ownerState.color]), ownerState.color !== 'context' && ownerState.invertedColors && theme.colorInversion[ownerState.variant]?.[ownerState.color], p !== undefined && {
    '--Card-padding': p
  }, padding !== undefined && {
...
const Card = /*#__PURE__*/React.forwardRef(function Card(inProps, ref) {
  ...
  const result = /*#__PURE__*/_jsx(SlotRoot, _extends({}, rootProps, {
